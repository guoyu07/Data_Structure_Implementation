...
class LListImpl{
	...
	Node head;				//Stores the reference of starting  point of the list
	Node current;
	Node prev;
	Node temp;
	...
	public void linkedListInsertion(int data){
		Node node = new Node(data);				//Creating a new node- node and its data field stores data value through 
