//Implementaion of Singly Circular Linked List
...
class CSLListImpl{
	...
	//Private class node so that it can be only accessed by CSLListImpl class
...
//Driver class for CSLListImpl
//It extends CSLListImpl so that it can access its protected operations(Methods)
class CSLListDriver extends CSLListImpl{
	public static void main(String[] args){
		CSLListImpl obj = new CSLListImpl();
		Node ref1,ref2,ref3;
