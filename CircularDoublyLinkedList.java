...
class CircularDoublyLinkedList{
    ...
    protected void removeKey(int key){
        if(isEmpty()){
            ...
            if(flag == 0){
                System.out.println("Key not found in the entire list");
                System.out.println();
            }
            else{
                System.out.println("Node or Nodes with value "+key+" is removed");
                traverseList();
            }
        }
    }
...
//Driver class for the CircularDoublyLinkedList class
class CircularDoublyLinkedListDriver extends CircularDoublyLinkedList{
...
Node or Nodes with value 20 is removed
Current contents of the List : 25 30 35 40 50 60 65

Node or Nodes with value 35 is removed
Current contents of the List : 25 30 40 50 60 65

Node or Nodes with value 65 is removed
...
Node or Nodes with value 60 is removed
...
Node or Nodes with value 30 is removed
